        ...
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <div class="rounded-2xl border border-red-100 bg-red-50/40 p-5">
                    ...
                    <p class="mt-1 text-sm font-medium text-red-700">Tạo và cập nhật thông tin khách sạn</p>
                </div>
                <div class="rounded-2xl border border-red-100 bg-red-50/40 p-5">
                    <p class="text-sm text-gray-600">Phòng và giá</p>
                    <p class="mt-1 text-sm font-medium text-red-700">Quản lý loại phòng và giá theo ngày</p>
                </div>
                <div class="rounded-2xl border border-red-100 bg-red-50/40 p-5">
                    <p class="text-sm text-gray-600">Đơn đặt của khách sạn</p>
                    <p class="mt-1 text-sm font-medium text-red-700">Theo dõi đơn thuộc khách sạn sở hữu</p>
                </div>
                <div class="rounded-2xl border border-red-100 bg-red-50/40 p-5">
                    <p class="text-sm text-gray-600">Hiệu suất</p>
                    <p class="mt-1 text-sm font-medium text-red-700">Doanh thu và công suất phòng (sắp có)</p>
                </div>
            </div>
        </div>
    </div>
