<x-app-layout>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-6xl space-y-4">
            <form method="GET"><input type="text" name="q" value="{{ request('q') }}" placeholder="{{ __('Tìm…') }}" class="rounded-xl border-gray-200 text-sm"> <x-primary-button type="submit">{{ __('Lọc') }}</x-primary-button></form>
