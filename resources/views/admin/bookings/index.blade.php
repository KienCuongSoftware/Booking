<x-app-layout>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl space-y-4">
            <div id="adminBookingsFilterRoot" class="space-y-4">
                <form method="GET" class="flex flex-wrap gap-2" data-ajax-filter-form data-ajax-target="#adminBookingsFilterRoot">
