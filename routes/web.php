...
use App\Http\Controllers\Customer\CustomerInboxController;
...
use App\Http\Controllers\Host\PhysicalRoomController as HostPhysicalRoomController;
...
use App\Http\Controllers\Public\GuestCheckInController;
use App\Http\Controllers\Public\GuestSavedHotelController;
...
Route::get('/saved-hotels', [GuestSavedHotelController::class, 'index'])
    ->middleware(['customer.public'])
    ->name('public.hotels.saved');
Route::post('/saved-hotels/{hotel}/toggle', [GuestSavedHotelController::class, 'toggle'])
    ->middleware(['customer.public'])
    ->name('public.hotels.saved.toggle');

Route::get('/legal/cancellation-refunds', [LegalPageController::class, 'cancellationRefunds'])->name('legal.cancellation-refunds');
...
Route::get('/check-in/guest', [GuestCheckInController::class, 'show'])
...
Route::middleware(['auth', 'verified', 'role:host'])->prefix('host')->name('host.')->group(function () {
    ...
    Route::get('/room-types/{roomType}/physical-rooms', [HostPhysicalRoomController::class, 'index'])->name('room-types.physical-rooms.index');
    Route::post('/room-types/{roomType}/physical-rooms', [HostPhysicalRoomController::class, 'store'])->name('room-types.physical-rooms.store');
    Route::patch('/physical-rooms/{physicalRoom}', [HostPhysicalRoomController::class, 'update'])->name('physical-rooms.update');
    Route::delete('/physical-rooms/{physicalRoom}', [HostPhysicalRoomController::class, 'destroy'])->name('physical-rooms.destroy');
    Route::get('/bookings', [HostBookingController::class, 'index'])->name('bookings.index');
    Route::patch('/bookings/{booking}/physical-room', [HostBookingController::class, 'updatePhysicalRoom'])->name('bookings.update-physical-room');
    ...
    Route::get('/reports/export.pdf', [HostReportsController::class, 'exportPdf'])->name('reports.export.pdf');
...
Route::middleware(['auth', 'verified', 'role:customer'])->prefix('customer')->name('customer.')->group(function () {
    ...
    Route::get('/inbox/unread-count', [CustomerInboxController::class, 'unreadCount'])
